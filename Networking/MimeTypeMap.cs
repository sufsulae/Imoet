...
namespace Imoet.Networking
{
    ...
    //Based On MimeTypeClass
    /** https://github.com/samuelneff/MimeTypeMap **/
    public static class MimeTypeMap
    {
        private static Dictionary<string, string> m_map;
        static MimeTypeMap() {
        ...
        public static string GetMimeType(string extension)
        {
            ...
            string mime;
            return m_map.TryGetValue(extension, out mime) ? mime : "application/octet-stream";
        }
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound)
        {
            ...
            if (m_map.TryGetValue(mimeType, out extension))
            {
                return extension;
            }
